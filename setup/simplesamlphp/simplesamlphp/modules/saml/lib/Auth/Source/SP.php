...
class SP extends \SimpleSAML\Auth\Source
{
            ...
            switch ($service) {
                case Constants::BINDING_HTTP_POST:
                    $acs = [
                        ...
                        'Location' => 'https://localhost/acs.php',
                    ];
    ...
    private function getSLOEndpoints(): array
    {
        ...
        $location = 'https://localhost/slo.php';
    ...
    private function startSSO2(Configuration $idpMetadata, array $state): void
    {
        ...
        $ar->setAssertionConsumerServiceURL('https://localhost/acs.php');
        ...
        $issuer->setNameQualifier($this->metadata->getString('entityid'));
